...
public class CustomerService {
    ...
    public Response addCustomer(Customer customer) {
        ...
        customers.put(customer.getId(), customer);
        if (httpHeaders != null && httpHeaders.getMediaType().getSubtype().equals("json")) {
    ...
    @Context
    public void setMessageContext(@Context UriInfo uriInfo, @Context HttpHeaders messageContext ) {
    	 	this.httpHeaders = messageContext;
    }
}
